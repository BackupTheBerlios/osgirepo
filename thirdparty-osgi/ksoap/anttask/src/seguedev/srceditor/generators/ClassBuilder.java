...
public class ClassBuilder
{
    ...
    public ClassBuilder(Class _clazz, Field _fields[], boolean _overwrite)
    {
        origFields = null;
        clazz = null;
        nativeToKsoapMap = new HashMap();
        overwrite = true;
        clazz = _clazz;
        origFields = _fields;
    ...
    {
        for(Iterator i = clazz.myMember.iterator(); i.hasNext();)
        {
            Object o = i.next();
    ...
    private String getSetterBlockForField(Field nativeField)
    {
        ...
        if(nativeType.getTypeName().equals("long"))
            return nativeField.getUnqualifiedName() + " = ((Long) obj).longValue();";
        if(nativeType.getTypeName().equals("java.lang.String"))
