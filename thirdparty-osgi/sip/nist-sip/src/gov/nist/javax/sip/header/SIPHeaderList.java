...
public class SIPHeaderList extends SIPHeader implements java.util.List {
	...
	public Object clone() {
		try {
			SIPHeaderList retval =
				(SIPHeaderList) this.getClass().newInstance();
			// Bug report by Slava Rey Calatayud.
			retval.headerName = this.headerName;
			for (SIPHeader v = (SIPHeader) this.first();
				v != null;
 ...
 *
 * Revision 1.1  2004/11/14 14:30:02  andfrei
